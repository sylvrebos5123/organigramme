...
$sql="SELECT * FROM cpas_grades_cadre order by libelle;";
...
$tab_grades_cadre=fn_ResultToArray($result,"id_grade_cadre");
...
$nomTable="array_grade_cadre";

$initialisation="$".$nomTable."=array(); \n";	


$outStr.="$".$nomTable."[0]='---'; \n";
foreach ($tab_grades_cadre as $key => $value)
{
	
	$outStr.="$".$nomTable."[".$value['id_grade_cadre']."]=\"".$value['libelle']."\"; \n";
