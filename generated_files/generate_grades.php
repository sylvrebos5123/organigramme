...
$sql="SELECT * FROM cpas_grades order by libelle_F;";
...
$tab_grades=fn_ResultToArray($result,"id_grade");
...
$nomTable="array_grade";

$initialisation="$".$nomTable."=array(); \n";	

$outStr.="$".$nomTable."[0]['F']='---'; \n";
$outStr.="$".$nomTable."[0]['N']='---'; \n";
foreach ($tab_grades as $key => $value)
{
	
	$outStr.="$".$nomTable."[".$value['id_grade']."]['F']=\"".$value['libelle_F']."\"; \n";
