...
$sql="SELECT * FROM cpas_etats_civils order by libelle_F;";
...
$tab_etats_civils=fn_ResultToArray($result,"id_etat_civil");
...
$nomTable="array_etat_civil";

$initialisation="$".$nomTable."=array(); \n";	

$outStr.="$".$nomTable."[0]['F']='---'; \n";
$outStr.="$".$nomTable."[0]['N']='---'; \n";
foreach ($tab_etats_civils as $key => $value)
{
	
	$outStr.="$".$nomTable."[".$value['id_etat_civil']."]['F']=\"".$value['libelle_F']."\"; \n";

	$outStr.="$".$nomTable."[".$value['id_etat_civil']."]['N']=\"".$value['libelle_N']."\"; \n";
