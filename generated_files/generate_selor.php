...
$sql="SELECT * FROM cpas_selor order by libelle_F;";
...
$tab_selor=fn_ResultToArray($result,"id_selor");
...
$nomTable="array_selor";

$initialisation="$".$nomTable."=array(); \n";	

//$outStr.="$".$nomTable."[0]['F']='---'; \n";
//$outStr.="$".$nomTable."[0]['N']='---'; \n";
foreach ($tab_selor as $key => $value)
{
	
	$outStr.="$".$nomTable."[".$value['id_selor']."]['F']=\"".$value['libelle_F']."\"; \n";
