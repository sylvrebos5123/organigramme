...
<br>
	<form id="FORM_DATE_CADRE_DIRIGEANT" name="FORM_DATE_CADRE_DIRIGEANT" action="<?php echo $lien;?>" method="post" onchange="SetColorButton(this.id);" onkeyup="SetColorButton(this.id);">
	...
	<tr>
		...
		<input type="text" id="art_budgetaire" name="art_budgetaire" style="width:99%" value="<?php echo $art_budgetaire;?>" <?php echo $disabled;?>/>
		<br><br>
		</td>
	...
	<input type="hidden" id="type_cadre" name="type_cadre" value="2" />

	<br>
	<p align="center">
		<input type="button" id="bnt_sauver" style="visibility:visible;" onclick="fFormSubmit('FORM_DATE_CADRE_DIRIGEANT');" value="<?php echo dico("sauver","F");?>" disabled />
		<input type="button" id="bnt_reset" style="visibility:visible;" onclick="resetFields('FORM_DATE_CADRE_DIRIGEANT')" value="<?php echo dico("reset","F");?>" />
