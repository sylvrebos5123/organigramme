...
if(($autre_type_fonc!='')&&($autre_type_fonc!="Précisez la fonction"))
{
...
include('../connect_db.php');
	...
	$sql="
		...
		,actif='".$actif."'
		,date_debut_fonction='".transformDate($date_debut_fonction)."'
		,date_echeance_fonction='".transformDate($date_echeance_fonction)."'
		,modif_date=NOW()
	...
	if(!$result)
	{
		echo "alert('Problème de modification du mouvement de fonction');";
		exit;
	}
	else
	{
		echo "alert('Mouvement de fonction modifié avec succès');";
	}
...
/* echo "
var MyForm=document.getElementById('FORM_MVT_FONCTION');
