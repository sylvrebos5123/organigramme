...
include('../connect_db.php');
	...
	$sql="
			...
			,date_debut_regime='".transformDate($date_debut_regime)."'
			,date_echeance_regime='".transformDate($date_echeance_regime)."'
			,actif='".$actif."'
			,modif_date=NOW()
	...
	if(!$result)
	{
		echo "alert('Problème de modification du mouvement de régime');";
		exit;
	}
	else
	{
		echo "alert('Mouvement de régime modifié avec succès');";
	}
