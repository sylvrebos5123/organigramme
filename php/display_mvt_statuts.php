...
{
	//echo '<div class="td_list_title"> >> Mouvement(s) de statut <span style="background-color:#B0F276;color:black;font-weight:bold;height:30px;width:30px;" title="Ajout d\'un mouvement dans le temps" onclick="DisplayFormMvt(\'DIV_FORM_MVT_STATUT\',\'statut\','.$id_agent.','.$id_contrat.');">&nbsp;+&nbsp;</span></div>';
	echo "Il n'y a pas encore de mouvement encodé pour cet agent. "; 
	echo 'Cliquez sur le bouton "+" pour ajouter un mouvement de statut.';
	echo "<br><br>";
...
if($tab_mvt_statuts!=null)
{
	...
	echo '<table border="0" cellpadding="0" cellspacing="0">';
		...
		echo '<tr>';
			...
			echo '<td class="td_list" style="width:120px;padding:5px;text-align:center;">Statut</td>';
			echo '<td class="td_list" style="width:120px;padding:5px;text-align:center;">Statut spécial</td>';
			echo '<td class="td_list" style="width:100px;padding:5px;text-align:center;">Contractuel/nommé</td>';
			echo '<td class="td_list" style="width:66px;padding:5px;text-align:center;"></td>';
