...
include('../connect_db.php');
	...
	$sql="
			...
			,id_code='".$id_code."'
			,id_grade='".$id_grade."'
			,date_debut_bareme='".transformDate($date_debut_bareme)."'
			,date_echeance_bareme='".transformDate($date_echeance_bareme)."'
			,id_bareme_cadre='".$id_bareme_cadre."'
			,id_code_cadre='".$id_code_cadre."'
			,id_grade_cadre='".$id_grade_cadre."'
	...
	if(!$result)
	{
		echo "alert('Problème de modification du mouvement de barème');";
		exit;
	}
	else
	{
		echo "alert('Mouvement de barème modifié avec succès');";
	}
